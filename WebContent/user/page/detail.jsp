        ...
        <div class="all">
            ...
            <div id="parm">
                ...
                <ul>
                    ...
                    <li><a href="#">作者：<%=book.getAuthor() %></a>
		            </li><li><a href="#">价格：<%=book.getPrice() %></a></li>
...
<script>
    ...
    $("#add_cart").click(function (e) {
        ...
        var params = {
        	count: buyAccount,
        	product: <%=book.getIsbn()%>// 书籍编号
        };
        $.ajax({
            type: "post",
            url: "/test03/user/page/addBookToCartServlet",
            data: params,
            success: function (data) {
                if (data == 'yes') {
                    alert("添加购物车成功！");
